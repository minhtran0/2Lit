				...
				<div class="col-md-8">
					<form method="post">								<!-- Registration form start-->
						...
						<div class="form-group">
							<div class="checkbox">
								<label>
									<input type="checkbox" required> I agree to the <a target="_blank" href="termsandconditions.html">Terms and Conditions</a> and have read the <a target="_blank" href="privacypolicy.html">Privacy Policy</a>
								</label>
							</div>
						</div>
						<button type="submit" class="btn btn-default" name="submit" id="submit" method="post">Create an account</button>
